...
public abstract class MicroService implements Runnable {
    ...
    private HashMap<Class,Callback> callbackByMessage = new HashMap<>();
    private ArrayList<Class> typesToRegister = new ArrayList<>();
    ...
    public ArrayList<Class> getTypesToRegister() {
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        ...
        callbackByMessage.putIfAbsent(type,callback);
    ...
    public final void run() {
            ...
            while (!terminated) {
                try {
                    ...
                    callbackByMessage.get(m.getClass()).call(m);
